--------------------------------------------------------
--  File created - Tuesday-March-21-2017   
--------------------------------------------------------
DROP VIEW "PTR"."CLOCKINSHIFTS";
DROP TABLE "PTR"."BANKING";
DROP TABLE "PTR"."CHAT";
DROP TABLE "PTR"."CLOCK-IN";
DROP TABLE "PTR"."EMPLOYEES";
DROP TABLE "PTR"."SHIFTS";
DROP TABLE "PTR"."STORES";
DROP SEQUENCE "PTR"."EMP_SEQ";
DROP SEQUENCE "PTR"."SHIFTS_SEQ";
DROP SEQUENCE "PTR"."STORES_SEQ";
DROP FUNCTION "PTR"."CUSTOM_AUTH";
DROP FUNCTION "PTR"."CUSTOM_HASH";
--------------------------------------------------------
--  DDL for View CLOCKINSHIFTS
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "PTR"."CLOCKINSHIFTS" ("SHIFTID", "EMPLOYEEID", "SHIFTSTART", "SHIFTEND", "END", "BEGIN") AS 
  SELECT SHIFTID, EMPLOYEEID, SHIFTSTART,SHIFTEND, END, BEGIN FROM "CLOCK-IN" LEFT JOIN SHIFTS ON "CLOCK-IN".SHIFTID=SHIFTS.ID;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PTR"."SHIFTS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into PTR.CHAT (CHATFILE,LASTMOD,EMAIL,LASTLOG) values ('ze_yaya@yahoo.fr-ze_yaya@msn.com.xml',1488696191,'ze_yaya@msn.com',1490054703);
...
Insert into PTR.CHAT (CHATFILE,LASTMOD,EMAIL,LASTLOG) values ('ze_yaya@msn.com-zeyaya94@gmail.com.xml',1488696173,'ze_yaya@msn.com',1490054704);
...
SET DEFINE OFF;
Insert into PTR."CLOCK-IN" (SHIFTID,EMPLOYEEID,SHIFTSTART,SHIFTEND,TIMSTANT) values (1,23,1490094328,1490094349,null);
Insert into PTR."CLOCK-IN" (SHIFTID,EMPLOYEEID,SHIFTSTART,SHIFTEND,TIMSTANT) values (21,23,1490096319,null,null);
...
SET DEFINE OFF;
Insert into PTR.SHIFTS (ID,STOREID,BEGIN,END) values (1,1,1490052417,1490152417);
Insert into PTR.SHIFTS (ID,STOREID,BEGIN,END) values (21,1,1490088390,1490188390);
...
REM INSERTING into PTR.CLOCKINSHIFTS
SET DEFINE OFF;
Insert into PTR.CLOCKINSHIFTS (SHIFTID,EMPLOYEEID,SHIFTSTART,SHIFTEND,END,BEGIN) values (1,23,1490094328,1490094349,1490152417,1490052417);
Insert into PTR.CLOCKINSHIFTS (SHIFTID,EMPLOYEEID,SHIFTSTART,SHIFTEND,END,BEGIN) values (21,23,1490096319,null,1490188390,1490088390);
--------------------------------------------------------
