    ...
    <body style='background-color: #677979; color: black; font-family: sans-serif; display: table; table-layout: auto; width: 100%; margin: 0; padding: 0; padding-bottom: 25px' bgcolor='#677979';>
        <div style='display: table-cell; width: 100%;'>
            ...
            <h2>Welcome to ClothingCo.</h2>
                <div>You must be excited to start your new job as $position at $store, but before you can start working and getting paid, you need to complete the following steps to ensure we have all you details:
                <ol>
...
";
//Emailer('ze_yaya@msn.com', null, "Welcome to ClothingCo.", null,null,null,null,null,null,$html);
echo $html;
?>