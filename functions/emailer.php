...
function Emailer($toEmail, $message, $Mailsubject, $fromEmail, $fromName, $sendingName, $filePath, $fileNametoDisplay, $greeting = "Hello,", $html = null)
{
