	...
	<body>
		...
		<div class="side_menu" id="MainSideMenu">
            <div class="side_menu_container">
                ...
                <div class="menu_itemLink_container"><a location="../cgit2" rel="address:/pay" metatitle="Pay" loadType="append" href="#/pay"  class="menu_item ContentWithin"><div class="icons">$</div>Pay</a></div>
                <?php
