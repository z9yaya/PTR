...
<?php if ($_SESSION['TYPE'] === 'CEO') {
    echo '<div class="Radiocontainers noClick">
        ...
        <div class="containers">
            <input type="text" id="position" name="string:employment:position" class="text input" autocorrect="off" autocapitalize="off" required autocomplete="off" disabled>
        ...
        <div class="Radiocontainers noClick">
            ...
            <input type="text" id="rate" name="float:employment:rate" class="text input Money" autocorrect="off" autocapitalize="off" required autocomplete="off" disabled>
        ...
        <input type="hidden" id="empIDinput" name="number:employees:empid">
