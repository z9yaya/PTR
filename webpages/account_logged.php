...
<div class="accountContent ">
    <div class="accountInfo boxContainer preload">
        <div id="uploadingPageOverlay" class="PageLoadingNormal"><div class="loading"><div class="animationCircle"></div></div></div>
    ...
    <form class="form accountPages preload" method="POST" action="#">
        <div class="employeeDetails boxContainer">
            ...
            <div class="containers">
                    <input id="l_name" type="text" name="string:employees:l_name" class="text input">
            ...
            <div class="containers negativeMarg">
                    <input id="phone" type="text" name="number:employees:phone" class="text input" maxlength="10">
        ...
        <div class="addressDetails boxContainer">
            <div class="containers">
                    <input id="street1" type="text" name="string:employees:street1" class="text input">
            ...
            <div class="containers inline">
                    <input id="postcode" type="text" name="number:employees:postcode" class="input text nomarg" size="8" maxlength="4">
                    <label for="postcode"  class="label">Postcode</label>
                    <div class="errorContainer"><span class="error postcode"></span></div>
            </div>
            <div class="containers inline">
                    <select id="state" name="string:employees:state" class="input text nomarg drop">
        ...
        <div class="bankingDetails boxContainer">
            <div class="containers inline">
                    <input id="tfn" type="text" name="number:banking:tfn" class="text input nomarg"  maxlength="10" size="20">
                    <label for="tfn"  class="label">Tax File Number (TFN)</label>
                    <div class="errorContainer"><span class="error tfn"></span></div>
            </div>
            <div class="containers inline">
                    <input id="bankname" type="text" name="string:banking:bankname" class="text input nomarg" >
                    <label for="bankname"  class="label">Bank name</label>
                    <div class="errorContainer"><span class="error bankname"></span></div>
            </div><br/>
            <div class="containers inline">
                    <input id="bsb" type="text" name="number:banking:bsb" class="text input bsb nomarg" minlenght="6" size="6" maxlength="6">
                    <label for="bsb"  class="label">BSB</label>
                    <div class="errorContainer"><span class="error bsb"></span></div>
            </div>
            <div class="containers inline">
                    <input id="accnumber" type="text" name="number:banking:accnumber" class="text input nomarg">
                    <label for="accnumber"  class="label">Account number</label>
                    <div class="errorContainer"><span class="error accnumber"></span></div>
            </div>
        </div>
        <div class="errorContainer"><span class="error emptyForm"></span></div>
